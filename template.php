...
<html>
	...
	<body onload="callFunction()">
		...
		<div id="left">
			...
			<div id="equip">
				...
				<div class="extrastats">'.$StatBon.'</div>
			</div>
			<div id="inventory">
				'.$inventoryTemplate.'
			</div>
	...
	<footer class="linksB">
		<br>
		<a href="https://docs.google.com/document/d/1-mFNUtG5JPODgaGGs804xrI9LU587AgsUCHiIXmBTkQ/edit?usp=sharing" target="_blank">Change log ('.$version.')</b></a>
